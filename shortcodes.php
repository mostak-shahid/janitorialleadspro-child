...
function social_menu_func( $atts = array(), $content = '' ) {
    ...
    if ($atts['links']) {
        ...
        foreach($slices as $url){
            $html .='<li>';
            $url = trim($url);
            if (preg_match('/facebook/i', $url)) $html .= '<a class="facebook-link" href="'.$url.'" target="_blank"><i class="fa fa-facebook"></i></a>';
            elseif (preg_match('/skype/i', $url))$html .= '<a class="skype-link" href="'.$url.'"><i class="fa fa-skype"></i></a>';
            elseif (preg_match('/twitter/i', $url))$html .= '<a class="twitter-link" href="'.$url.'" target="_blank"><i class="fa fa-twitter"></i></a>';
            elseif (preg_match('/linkedin/i', $url))$html .= '<a class="linkedin-link" href="'.$url.'" target="_blank"><i class="fa fa-linkedin"></i></a>';
            $html .='</li>';
        }
        $html .='</ul>';
    }
